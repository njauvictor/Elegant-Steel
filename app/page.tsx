          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
                <span className="text-primary">Quality Steel</span> Solutions for East Africa
              </h1>
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Elegant Steel delivers premium metal fabrication and structural welding services. From industrial
                engineering to custom fabrication, we bring quality to your place.
              </p>

    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border bg-secondary/30 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-4">About Elegant Steel</h1>
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Founded in 2009, Elegant Steel & Fabricators emerged from a simple vision: to provide exceptional
            ...
            <div className="relative h-96">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-accent/20 rounded-lg overflow-hidden">
                <img src="/welding-workshop-team-professional.jpg" alt="Elegant Steel team" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-border bg-secondary/30 py-16">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="text-muted-foreground mb-8">
            Let's discuss how Elegant Steel can help bring your metal fabrication project to life.
          </p>
          <a
            href="/contact"
